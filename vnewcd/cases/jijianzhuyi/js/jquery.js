...
(function (e, t) {
	...
	b.ajaxPrefilter("json jsonp", function (n, r, i) {
		...
		a,
		s,
		u = n.jsonp !== !1 && (Bn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("contentType:application/x-www-form-urlencoded; charset=UTF-8") && Bn.test(n.data) && "data");
