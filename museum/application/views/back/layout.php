...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <!-- <li  class="active"><a href="<?php echo base_url('back/view/layout')?>">基本陈列</a></li> -->
            <li><a href="<?php echo base_url('back/view/index') ?>">珍品赏析</a></li>
        ...
        <div>
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row">
              <div class="col-md-10 page-header" style="height:60px;line-height:60px; font-size:24px">基本陈列</div>
            </div>
    ...
    <script src="<?php echo base_url('assets/back/js/layout.js') ?>"></script>
