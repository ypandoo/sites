...
<body>
  ...
  <?php include 'header_navi.php'; ?>
    <!-- <i class="line" style="margin-top:80px  ;"> </i> -->
    <div id="myPano" class="pano" style="height:400px; margin-top:80px  ;">
    ...
    <div class="locations" style="margin-bottom:20px">
...
<script src="<?php echo base_url('assets/pc/js/360.js') ?>"></script>
