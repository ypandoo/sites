...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/front/css/layout.css') ?>">
</head>
<body>

<div id="details" class="details"  ms-controller="layout_ctrl">
    <!--首页-->
    ...
    <div style="height:20px; background: #ec422b;position:fixed; bottom:0; ">
    </div>
