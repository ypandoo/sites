pHPSetupFunction=function(){
	...
	if(L){
		...
		var K=jQuery("#p-top-banner .p-top-qh-pane").scrollable({easing:"custom",speed:1200,circular:true}).navigator().autoscroll({interval:3000})
	}
	...
	jQuery(window).resize(resize_callback);
	resize_callback();
