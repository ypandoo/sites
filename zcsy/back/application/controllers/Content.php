...
class Content extends CI_Controller {
    ...
    public function new_content()
    {
        ...
        //  'content_type': content_ctrl.content_type
         ...
         $content_pic = $this->input->post('content_pic');
         ...
         $insertdata['CONTENT_PIC'] = $content_pic;
    ...
    public function add_pic()
    {
        ...
        if ($original_name) {
             move_uploaded_file($_FILES["file"]["tmp_name"], $_SERVER['DOCUMENT_ROOT']."/back/uploads/content_pic/".$original_name);
        }
        else {
            $data_result["success"] = 0;
            $data_result["errorCode"] = 2;
